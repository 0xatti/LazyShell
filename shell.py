...
# tun1 = netifaces.ifaddresses('tun1')[netifaces.AF_INET][0]['addr']
ip = tun0
port_list = [4444, 4200, 6969, 7777, 8675, 9110, 3456,
             6789, 8181, 4545, 5656, 4745, 3985, 2580, 3099]
port = random.choice(port_list)


# Shell-Text Variables
# Bash Shell
bash = f"""
     ---------------------------------------------------------------
